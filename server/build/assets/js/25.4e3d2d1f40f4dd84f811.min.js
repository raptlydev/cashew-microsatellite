...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return convertToPercentage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return pad2; });
/**
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return rgbToRgb; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return parseIntFromHex; });
/* unused harmony export numberInputToObject */
...
function rgbToHex(r, g, b, allow3Char) {
    var hex = [
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(Math.round(r).toString(16)),
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(Math.round(g).toString(16)),
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(Math.round(b).toString(16)),
    ];
...
function rgbaToHex(r, g, b, a, allow4Char) {
    var hex = [
        ...
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(Math.round(g).toString(16)),
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(Math.round(b).toString(16)),
        Object(_util__WEBPACK_IMPORTED_MODULE_0__[/* pad2 */ "d"])(convertDecimalToHex(a)),
    ];
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ inputToRGB; });

// UNUSED EXPORTS: stringInputToObject, isValidCSSUnit

// EXTERNAL MODULE: ./node_modules/@ctrl/tinycolor/dist/module/conversion.js
var conversion = __webpack_require__(27);
...
function inputToRGB(color) {
    ...
    if (typeof color === 'object') {
        if (isValidCSSUnit(color.r) && isValidCSSUnit(color.g) && isValidCSSUnit(color.b)) {
            rgb = Object(conversion["g" /* rgbToRgb */])(color.r, color.g, color.b);
            ok = true;
            format = String(color.r).substr(-1) === '%' ? 'prgb' : 'rgb';
        }
        else if (isValidCSSUnit(color.h) && isValidCSSUnit(color.s) && isValidCSSUnit(color.v)) {
            s = Object(util["c" /* convertToPercentage */])(color.s);
            v = Object(util["c" /* convertToPercentage */])(color.v);
            rgb = Object(conversion["c" /* hsvToRgb */])(color.h, s, v);
            ok = true;
            format = 'hsv';
        }
        else if (isValidCSSUnit(color.h) && isValidCSSUnit(color.s) && isValidCSSUnit(color.l)) {
            s = Object(util["c" /* convertToPercentage */])(color.s);
            l = Object(util["c" /* convertToPercentage */])(color.l);
            rgb = Object(conversion["b" /* hslToRgb */])(color.h, s, l);
            ok = true;
            format = 'hsl';
        }
...
function stringInputToObject(color) {
    ...
    if (match) {
        return {
            r: Object(conversion["d" /* parseIntFromHex */])(match[1]),
            g: Object(conversion["d" /* parseIntFromHex */])(match[2]),
            b: Object(conversion["d" /* parseIntFromHex */])(match[3]),
            a: Object(conversion["a" /* convertHexToDecimal */])(match[4]),
    ...
    if (match) {
        return {
            r: Object(conversion["d" /* parseIntFromHex */])(match[1] + match[1]),
            g: Object(conversion["d" /* parseIntFromHex */])(match[2] + match[2]),
            b: Object(conversion["d" /* parseIntFromHex */])(match[3] + match[3]),
            a: Object(conversion["a" /* convertHexToDecimal */])(match[4] + match[4]),
            format: named ? 'name' : 'hex8',
        };
    }
...
//# sourceMappingURL=vendor.ctrl.4e3d2d1f40f4dd84f811.js.map